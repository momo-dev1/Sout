...
| `Gemini rate limit reached. Wait a moment, then try again.` | Too many requests for your quota (429). | Wait a minute and retry. Persistent limits mean the project's quota is exhausted. |
